// StoreDetailScreen.tsx - COMPLETO CON COMENTARIOS Y FEEDBACKS
      ...
      <ScrollView showsVerticalScrollIndicator={false}>
        ...
        <View style={styles.headerCard}>
          <View style={styles.imageContainer}>
            <Image
              source={{
                uri: shop.image || "https://picsum.photos/400",
              }}
            ...
            {shopNews.length > 0 ? (
              shopNews.map((post) => (
                <View key={post.id} style={styles.card}>
                  <Image
                    source={{
                      uri: post.url || "https://picsum.photos/400",
                    }}
                    style={styles.productImage}
                  />
